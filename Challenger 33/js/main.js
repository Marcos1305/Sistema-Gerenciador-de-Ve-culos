(function(){
    ...
    function removeTableRow(buttonRemove){
        var tdplate = buttonRemove.parentNode.parentNode.childNodes[3].textContent
        ...
        deleteAjax.send('plate='+tdplate)
        deleteAjax.onreadystatechange = function(){
            if(deleteAjax.readyState === 4){
                var $msgfeedback = document.querySelector('[data-js="msgFeedback"]')
                $msgfeedback.textContent = 'Veículo com a placa '+tdplate +' excluído com sucesso!'
            }
        }
